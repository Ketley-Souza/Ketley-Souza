...
Tenho grande interesse em **Desenvolvimento Web** e **Experiência do Usuário (UX/UI)** pois acredito que pequenos detalhes podem transformar a experiência do usuário de frustrante para envolvente.

Atualmente curso Sistemas de Informação no Centro Universitário de Patos de Minas, onde venho aprimorando minhas habilidades técnicas e construindo uma base sólida para evoluir na área de Tecnologia da Informação.
<br><br>
